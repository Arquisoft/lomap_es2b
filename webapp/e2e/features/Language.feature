...
Scenario: A user enter the page and tries to change the language to Spanish
  When I change the language of the site to Spanish
  Then the text should change to Spanish
