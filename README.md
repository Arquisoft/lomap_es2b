...
[![Actions Status](https://github.com/arquisoft/lomap_es2b/workflows/CI%20for%20lomap_es2b/badge.svg)](https://github.com/arquisoft/lomap_es2b/actions)
...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es2b`. The fastest way to launch everything is with docker:
```bash
...
- Documentation: https://github.com/arquisoft/lomap_es2b/tree/master/docs
- Webapp: https://github.com/arquisoft/lomap_es2b/tree/master/webapp
- Restapi: https://github.com/arquisoft/lomap_es2b/tree/master/restapi
...
services:
  restapi:
    image: ghcr.io/arquisoft/lomap_es2b/restapi:latest
    ports:
      - "5000:5000"
  webapp:
    image: ghcr.io/arquisoft/lomap_es2b/webapp:latest
    ports:
      - "3000:3000"
    depends_on: 
      - restapi
